    ...
    <section style={{ maxWidth: '1100px', margin: '0 auto', padding: '70px 20px 60px' }}>
      <div className="hero-grid">
        ...
        <div>
          ...
          <h1 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: '800', lineHeight: '1.08', letterSpacing: '-1.5px', color: '#F9FAFB', marginBottom: '20px' }} className="hero-h1">
            Data Analyst<br />
          ...
          <p style={{ color: '#9CA3AF', fontSize: '15px', lineHeight: '1.7', maxWidth: '420px', marginBottom: '32px', fontWeight: '300' }}>
        ...
        <div className="hero-terminal-wrap">
          <div style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '24px', fontFamily: 'monospace', fontSize: '13px' }}>
      ...
      <style>{`
        ...
        .hero-terminal-wrap { display: flex; justify-content: flex-end; }
